...
The Joshternet does not require an account to read this site, participate in the network, or implement its specifications.

## Analytics

joshternet.org uses [Umami Cloud][umami] to understand aggregate website traffic and how people use the project documentation.
...
The Joshternet connects independently operated websites.

This privacy page describes joshternet.org. Participating Joshternet sites, JoshBot, registries, and other independently operated services may have their own data practices and policies.

Participation in the Joshternet does not place an independently operated website under the control of joshternet.org.
